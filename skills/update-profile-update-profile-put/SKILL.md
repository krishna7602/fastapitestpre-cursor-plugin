---
name: update-profile-update-profile-put
description: Update Profile
---

# update-profile-update-profile-put

## When to use
Use this skill when the user intent maps to `update-profile-update-profile-put` and the user is asking for actionable data retrieval or an operation that this tool can perform.
...
## Parameter Mapping
1. Read the MCP schema for `update-profile-update-profile-put` and list required vs optional parameters.
...
4. Call the `update-profile-update-profile-put` MCP tool with the correct parameters.
...
## Worked Example
- User intent: "Run `update-profile-update-profile-put` for my latest record and show key fields only."
- Action: Resolve the required identifier, call `update-profile-update-profile-put`, extract the top-level summary fields.
