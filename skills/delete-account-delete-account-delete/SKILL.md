---
name: delete-account-delete-account-delete
...
## When to use
Use this skill when the user intent maps to `delete-account-delete-account-delete` and the user is asking for actionable data retrieval or an operation that this tool can perform.
...
## Parameter Mapping
1. Read the MCP schema for `delete-account-delete-account-delete` and list required vs optional parameters.
...
4. Call the `delete-account-delete-account-delete` MCP tool with the correct parameters.
...
## Worked Example
- User intent: "Run `delete-account-delete-account-delete` for my latest record and show key fields only."
- Action: Resolve the required identifier, call `delete-account-delete-account-delete`, extract the top-level summary fields.
