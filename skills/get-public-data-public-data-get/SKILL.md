---
name: get-public-data-public-data-get
description: Get Public Data
---

# get-public-data-public-data-get

## When to use
Use this skill when the user intent maps to `get-public-data-public-data-get` and the user is asking for actionable data retrieval or an operation that this tool can perform.
...
## Parameter Mapping
1. Read the MCP schema for `get-public-data-public-data-get` and list required vs optional parameters.
...
4. Call the `get-public-data-public-data-get` MCP tool with the correct parameters.
...
## Worked Example
- User intent: "Run `get-public-data-public-data-get` for my latest record and show key fields only."
- Action: Resolve the required identifier, call `get-public-data-public-data-get`, extract the top-level summary fields.
