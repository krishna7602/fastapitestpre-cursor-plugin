---
name: create-post-create-post-post
description: Create Post
---

# create-post-create-post-post

## When to use
Use this skill when the user intent maps to `create-post-create-post-post` and the user is asking for actionable data retrieval or an operation that this tool can perform.
...
## Parameter Mapping
1. Read the MCP schema for `create-post-create-post-post` and list required vs optional parameters.
...
4. Call the `create-post-create-post-post` MCP tool with the correct parameters.
...
## Worked Example
- User intent: "Run `create-post-create-post-post` for my latest record and show key fields only."
- Action: Resolve the required identifier, call `create-post-create-post-post`, extract the top-level summary fields.
